...
public class ShadowLayout extends LinearLayout {
    ...
    //默认阴影半径
    public static final float SHADOW_DEFAULT_RADIUS =  DimenUtil.dp2px(5);

    //阴影最大偏移量
    public static final float SHADOW_MAX_OFFSET = DimenUtil.dp2px(20);

    //阴影最大模糊半径
    public static final float SHADOW_MAX_BLUR = DimenUtil.dp2px(20);



    //默认模糊半径
    public static final float SHADOW_DEFAULT_BLUR_RADIUS = DimenUtil.dp2px(5);
    ...
    //水平位移
    private float xOffset  = DimenUtil.dp2px(10);


    //竖直方向位移
    private float yOffset = DimenUtil.dp2px(10);
    ...
    public ShadowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        xOffset = typedArray.getDimension(R.styleable.ShadowLayout_xOffset,DimenUtil.dp2px(10));
        yOffset = typedArray.getDimension(R.styleable.ShadowLayout_yOffset,DimenUtil.dp2px(10));
