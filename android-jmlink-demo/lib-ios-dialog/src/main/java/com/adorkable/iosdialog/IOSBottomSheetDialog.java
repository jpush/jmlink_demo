...
public class IOSBottomSheetDialog {
    ...
    public IOSBottomSheetDialog init() {
        // 获取Dialog布局
    ...
    public IOSBottomSheetDialog setDefaultItemStyle(SheetItemTextStyle textStyle) {
        this.defaultItemStyle = textStyle;
        return this;
    }

    public IOSBottomSheetDialog setBottomBtnStyle(SheetItemTextStyle textStyle) {
    ...
    public IOSBottomSheetDialog addSheetItem(SheetItem sheetItem) {
        addSheetItem2List(sheetItem);
        return this;
    }

    public IOSBottomSheetDialog addSheetItem(String strItem, SheetItemTextStyle textStyle,
                                             OnSheetItemClickListener listener) {
        addSheetItem2List(new SheetItem(strItem, textStyle, listener));
        return this;
    }

    public IOSBottomSheetDialog addSheetItem(String strItem, OnSheetItemClickListener listener) {
        addSheetItem2List(
                new SheetItem(
                        strItem,
    ...
    private void setSheetItems() {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            int height = (int) (sheetItem.textStyle.height * scale + 0.5f);
    ...
    public static class SheetItemTextStyle {
        ...
        public final static int DEFAULT_HEIGHT = 57; //dp
        ...
        public SheetItemTextStyle(String textColor) {
            this(textColor, DEFAULT_TEXT_SIZE, DEFAULT_HEIGHT);
        }

        public SheetItemTextStyle(String textColor, int textSize) {
            this(textColor, textSize, DEFAULT_HEIGHT, Typeface.defaultFromStyle(Typeface.NORMAL));
        }

        public SheetItemTextStyle(String textColor, int textSize, int height) {
            this(textColor, textSize, height, Typeface.defaultFromStyle(Typeface.NORMAL));
        }

        public SheetItemTextStyle(String textColor, int textSize, int height, Typeface typeface) {
            this(Color.parseColor(textColor), textSize, height, typeface);
        }

        public SheetItemTextStyle(int textColor, int textSize, int height, Typeface typeface) {
